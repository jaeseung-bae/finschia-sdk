...
func (k Keeper) Attach(ctx sdk.Context, contractID string, owner sdk.AccAddress, subject, target string) error {
	...
	if err := k.subtractCoins(ctx, contractID, owner, collection.NewCoins(collection.NewCoin(subject, math.OneInt()))); err != nil {
...
func (k Keeper) Detach(ctx sdk.Context, contractID string, owner sdk.AccAddress, subject string) error {
	...
	k.addCoins(ctx, contractID, owner, collection.NewCoins(collection.NewCoin(subject, math.OneInt())))
