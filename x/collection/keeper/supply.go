...
func (k Keeper) getNextTokenID(ctx sdk.Context, contractID string, classID string) math.Uint {
	store := k.storeService.OpenKVStore(ctx)
...
func (k Keeper) setNextTokenID(ctx sdk.Context, contractID string, classID string, tokenID math.Uint) {
	store := k.storeService.OpenKVStore(ctx)
	key := nextTokenIDKey(contractID, classID)
...
func (k Keeper) getStatistic(ctx sdk.Context, keyPrefix []byte, contractID string, classID string) math.Int {
	store := k.storeService.OpenKVStore(ctx)
	amount := math.ZeroInt()
...
func (k Keeper) setStatistic(ctx sdk.Context, keyPrefix []byte, contractID string, classID string, amount math.Int) {
	store := k.storeService.OpenKVStore(ctx)
...
func (k Keeper) GetSupply(ctx sdk.Context, contractID string, classID string) math.Int {
	return k.getStatistic(ctx, supplyKeyPrefix, contractID, classID)
}

func (k Keeper) GetMinted(ctx sdk.Context, contractID string, classID string) math.Int {
	return k.getStatistic(ctx, mintedKeyPrefix, contractID, classID)
}

func (k Keeper) GetBurnt(ctx sdk.Context, contractID string, classID string) math.Int {
	return k.getStatistic(ctx, burntKeyPrefix, contractID, classID)
}

func (k Keeper) setSupply(ctx sdk.Context, contractID string, classID string, amount math.Int) {
	k.setStatistic(ctx, supplyKeyPrefix, contractID, classID, amount)
}

func (k Keeper) setMinted(ctx sdk.Context, contractID string, classID string, amount math.Int) {
	k.setStatistic(ctx, mintedKeyPrefix, contractID, classID, amount)
}

func (k Keeper) setBurnt(ctx sdk.Context, contractID string, classID string, amount math.Int) {
